...
use super::{
    ...
    permutation::{calc_orbit_stabilizer, Permutable, PermutationStore},
};
...
impl<const N: usize> Iterator for SaturatedHydrocarbonIter<'_, N> {
    ...
    fn next(&mut self) -> Option<Self::Item> {
        loop {
            ...
            let perm_iter = perms.iter().copied();
            let (orbit, stabilizer) = calc_orbit_stabilizer(skeleton, perm_iter);
